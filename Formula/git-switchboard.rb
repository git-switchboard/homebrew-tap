class GitSwitchboard < Formula
  ...
  version "0.0.1-prev.2"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/git-switchboard/git-switchboard/releases/download/git-switchboard%400.0.1-prev.2/git-switchboard-darwin-arm64"
      sha256 "f55d2c2d9d30d3b8964c6634f3824924acd5e8068d6a4fc1b12bab0c6c3590c4"
    else
      url "https://github.com/git-switchboard/git-switchboard/releases/download/git-switchboard%400.0.1-prev.2/git-switchboard-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/git-switchboard/git-switchboard/releases/download/git-switchboard%400.0.1-prev.2/git-switchboard-linux-arm64"
      sha256 "4a046c4088028ac03a6f283d1c6eb9eeee7707946824cb80fc840b93a4d3c260"
    else
      url "https://github.com/git-switchboard/git-switchboard/releases/download/git-switchboard%400.0.1-prev.2/git-switchboard-linux-x64"
